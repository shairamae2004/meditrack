...
public class doctorAppointments extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 49, 580, 380));
        ...
        jPanel5.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, 580, 40));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        doctorAppointments_admit open = new doctorAppointments_admit();
        open.setVisible(true);
        this.dispose();
    ...
    private void DELETE1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DELETE1ActionPerformed
        ...
        if(rowid != -1){
            ...
            if(confirm == JOptionPane.YES_OPTION){
                String insertQuery = "UPDATE tbl_appointments SET a_status = 'Archived' WHERE a_id = '"+id+"'";
