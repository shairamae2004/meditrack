 ...
 * @author w10
 */
public class doctorAppointments_edit extends javax.swing.JFrame {

    /**
     * Creates new form doctorAppointments_edit
     */
    public doctorAppointments_edit() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(doctorAppointments_edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new doctorAppointments_edit().setVisible(true);
            }
        });
    }
