 ...
 * @author w10
 */
public class doctorAppointments_add extends javax.swing.JFrame {

    /**
     * Creates new form doctorAppointments_edit
     */
    public doctorAppointments_add() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(doctorAppointments_add.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new doctorAppointments_add().setVisible(true);
            }
        });
    }
