 ...
 * @author w10
 */
public class fdPatients_edit extends javax.swing.JFrame {

    /**
     * Creates new form doctorAppointments_edit
     */
    public fdPatients_edit() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fdPatients_edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fdPatients_edit().setVisible(true);
            }
        });
    }
