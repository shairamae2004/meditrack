 ...
 * @author w10
 */
public class fdAppointments_edit extends javax.swing.JFrame {

    /**
     * Creates new form doctorAppointments_edit
     */
    public fdAppointments_edit() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fdAppointments_edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fdAppointments_edit().setVisible(true);
            }
        });
    }
