 ...
 * @author w10
 */
public class fdArchives extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5.add(DELETE, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 10, 70, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fdArchives.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fdArchives().setVisible(true);
            }
        });
    }
