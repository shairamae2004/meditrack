 ...
 * @author w10
 */
public class fdDoctors_add extends javax.swing.JFrame {

    /**
     * Creates new form doctorAppointments_edit
     */
    public fdDoctors_add() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Doctor/Staff");
        jPanel1.add(jLabel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fdDoctors_add.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fdDoctors_add().setVisible(true);
            }
        });
    }
